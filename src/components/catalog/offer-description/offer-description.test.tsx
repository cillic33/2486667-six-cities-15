...
import MemoOfferDescription from '@/components/catalog/offer-description/offer-description';
...
describe('Component: OfferDescription', () => {
  it('should render correctly', () => {
    ...
    renderWithRouterAndProviders(<MemoOfferDescription offer={mockOfferCard} />);
